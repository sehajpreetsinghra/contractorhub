        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <ActionButton href="/dashboard">Open Role Router</ActionButton>
              <ActionButton href="/contractor-submit/demo-token" variant="secondary">Preview Contractor Link</ActionButton>
            </div>
          </div>
