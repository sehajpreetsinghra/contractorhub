        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_0.8fr]">
          <PanelCard title="Contractor submission form" eyebrow="No login required">
            <form className="space-y-5">
              ...
              <div className="flex flex-wrap items-start gap-3"><ActionButton href={`/contractor-submit/${params.token}/confirmation`}>Submit Contractor Package</ActionButton><FeedbackActionButton label="Save Draft" message="Draft saved locally for this secure contractor token." variant="secondary" /></div>
            </form>
          </PanelCard>
